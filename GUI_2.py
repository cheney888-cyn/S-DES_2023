...
class SDESApp(QWidget):
    ...
    def initUI(self):
        ...
        self.paste_button.clicked.connect(self.paste_encrypted_text)
    ...
    def paste_encrypted_text(self):
        encrypted_text = self.result_label.text()
        self.cipher_text_input.setText(encrypted_text)
    ...
    def encrypt(self):
        ...
        encrypted_text = "".join(ciphertextlist)
